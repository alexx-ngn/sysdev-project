...
const translations: Record<Language, Translations> = {
  en: {
    ...
    'register.eventDetails.dateTime.value1': 'Saturday, October 15, 2023',
    'register.eventDetails.dateTime.value2': 'Starting at 7:00 AM',
    'register.eventDetails.location.title': 'Location',
    'register.eventDetails.location.value1': 'City Park',
    'register.eventDetails.location.value2': '123 Runner\'s Lane',
    'register.eventDetails.location.value3': 'Hopeville, State 12345',
