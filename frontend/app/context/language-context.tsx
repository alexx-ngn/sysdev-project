...
const translations: Record<Language, Translations> = {
  en: {
    ...
    'faq.q1.answer': 'The MilesForHope charity run will take place on TBD starting at 9:00 AM. The event will be held at CHU Sainte-Justine, 3175 Chem. de la Côte-Sainte-Catherine, Montréal, QC H3T 1C5.',
    ...
    'donate.oneTime.buttonWithAmount': 'Donate ${{amount}}',
    'donate.oneTime.buttonLoading': 'Processing...',
    ...
    'register.faq.q2.answer': 'Yes, free parking is available at CHU Sainte-Justine. We recommend taking public transportation if possible to reduce congestion.',
  ...
  fr: {
    ...
    'run.date.title': 'Date',
    'run.date.value': 'À déterminer ',
    'run.time.title': 'Heure',
    'run.time.checkin': 'Enregistrement : 9h00',
    'run.time.start': 'Départ de la course : 10h00',
    ...
    'run.courseInfo.description': 'Notre parcours de 5K est conçu pour être accessible aux participants de tous les niveaux de forme physique.',
    ...
    'run.schedule.checkin.time': '9h00',
    ...
    'run.schedule.warmup.time': '9h45',
    'run.schedule.warmup.title': 'Échauffement pré-course',
    'run.schedule.warmup.description': 'Rejoignez nous pour un échauffement en groupe!',
    'run.schedule.start.time': '10h00',
    'run.schedule.start.title': 'Départ de la course',
    'run.schedule.start.description': 'Début de la course à pied/marche de 5 km',
    'run.schedule.awards.time': '11h00',
    ...
    'run.schedule.celebration.time': '11h30',
    ...
    'faq.q1.answer': 'La course de bienfaisance MilesForHope aura lieu le XX, à partir de 9h00. L\'événement se déroulera au CHU Sainte-Justine, 3175 Chem. de la Côte-Sainte-Catherine, Montréal, QC H3T 1C5',
    ...
    'donate.oneTime.button': 'Donate Now',
    'donate.oneTime.buttonWithAmount': 'Faire un don de {{amount}} $',
    'donate.oneTime.buttonLoading': 'Traitement en cours...',
    ...
    'donate.impact.supplies.title': 'Collations saines pour les enfants',
    'donate.impact.supplies.description': 'Fournit des collations nutritives aux enfants lors des événements communautaires et des programmes parascolaires.',
    'donate.impact.research.title': 'Fournitures scolaires',
    'donate.impact.research.description': 'Aide à acheter des sacs à dos, des cahiers et d\'autres essentiels pour les enfants dans le besoin dans les écoles locales.',
    'donate.impact.equipment.title': 'Fonds d\'activités',
    'donate.impact.equipment.description': 'Soutient les activités sportives, artistiques et d\'enrichissement pour les enfants du quartier.',
    ...
    'register.eventDetails.dateTime.value1': 'À venir',
    'register.eventDetails.dateTime.value2': 'Début à 9h00',
    ...
    'register.faq.q2.answer': 'Oui, un stationnement gratuit est disponible au CHU Sainte-Justine. Nous recommandons le transport en commun si possible pour réduire la congestion.',
    'register.faq.q3.question': 'Puis-je m\'inscrire le jour de l\'événement ?',
    'register.faq.q3.answer': 'Oui, l\'inscription le jour même sera disponible à partir de 9h00, mais nous recommandons de s\'inscrire à l\'avance pour garantir votre place et votre taille de t-shirt.',
